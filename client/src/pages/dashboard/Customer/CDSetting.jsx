          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="group">
                ...
                >
                  <Mail size={18} strokeWidth={2.5} /> {profile.email}
                </div>
              </div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-5 bg-slate-900 dark:bg-white dark:text-slate-900 rounded-3xl font-black uppercase text-xs tracking-[0.3em] transition-all active:scale-95 flex items-center justify-center gap-3 mt-4 shadow-xl"
              >
...
const StatCard = ({ icon, label, value, color, theme, isVerified }) => {
  ...
  return (
    ...
    >
      <div
        className={`w-16 h-16 shrink-0 rounded-[1.25rem] flex items-center justify-center ${colorMap[color]}`}
      >
